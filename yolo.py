...
labelMap = [
    "cat",         "bicycle",    "car",           "motorbike",     "aeroplane",   "bus",           "train",
    "truck",          "boat",       "traffic light", "fire hydrant",  "stop sign",   "parking meter", "bench",
    "bird",           "person",        "dog",           "horse",         "sheep",       "cow",           "elephant",
...
# create a publisher for the result image
...
# Publish the ROS image message to the 'result_image' topic
